...
2. **Assemble Payload**: Consolidates lead attributes, company dossier from [`Context`](apps/frappe_cadence/frappe_cadence/cadence/doctype/context/context.py:6), and sender details into dynamic subscriber attributes.
