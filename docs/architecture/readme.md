...
### 2. Behavioral Process Models (`bpmn/`)
- [01. Lead Cadence Enrollment](bpmn/01-lead-cadence-enrollment.md)
- [02. Playbook Provisioning](bpmn/02-playbook-provisioning.md)
...
- [02. Architecture Constraints](arc42/02-architecture-constraints.md)
- [03. Context & Scope](arc42/03-context-and-scope.md)
...
- [09. Architecture Decisions (ADRs)](arc42/09-architecture-decisions/0001-record-architecture-decisions.md)
- [10. Quality Requirements](arc42/10-quality-requirements.md)
- [11. Risks & Technical Debts](arc42/11-risks-and-technical-debts.md)
